...
common_voice_train = load_dataset("multilingual_librispeech", "portuguese", split="train+validation")
common_voice_test = load_dataset("multilingual_librispeech", "portuguese", split="test")
...
training_args = TrainingArguments(
  ...
  eval_steps=2000,
  logging_steps=200,
  learning_rate=0.3e-5, # 0.5e-4, #0.9e-4 ## DIMINUIR LEARNING RATE 
#  weight_decay=0.0,
  warmup_steps=200,
  save_total_limit=10,
  push_to_hub=False,
