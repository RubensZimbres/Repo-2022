...
to setup
  ...
  crt 70 [ setxy random-xcor random-ycor
...
to generate-random
  generate  [ -> nw:generate-random  turtles get-links-to-use nb-nodes connection-prob [set color green
    setxy  random-xcor random-ycor ]]
  print get-links-to-use
end
...
"" ""
PENS
"%Similar" 1.0 1 -16777216 true "" "histogram [ count my-links ] of turtles"
