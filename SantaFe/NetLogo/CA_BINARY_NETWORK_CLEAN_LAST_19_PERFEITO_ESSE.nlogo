...
to setup
  ...
  crt 60 [setxy random-xcor random-ycor
...
to resize-node
    ...
    ask turtles [ set size ( sqrt count link-neighbors ) / 7 ]
end

to make-node [old-node]
  ask turtles
  [    set neighbor-left one-of other turtles
       set neighbor-right one-of other turtles


    if old-node != nobody
      [
        create-link-with neighbor-left [ set color 42 ]
...
"" ""
PENS
"State 0" 1.0 0 -2674135 true "" "plot count turtles with [ state = 0]"
"State 1" 1.0 0 -1604481 true "" "plot count turtles with [ state = 1]"
"State 2" 1.0 0 -1184463 true "" "plot count turtles with [ state = 2]"
"State 3" 1.0 0 -5509967 true "" "plot count turtles with [ state = 3]"
"State 4" 1.0 0 -13840069 true "" "plot count turtles with [ state = 4]"
