...
to setup
  ...
  file-open "/home/theone/Downloads/NetLogo/relationships_matrix.graphml"     ;; add your path here
    ask turtles [    if state = 0 [ set color red ]         ; colors of each one of the 5 states of the agents
...
to resize-node
    ...
    ask turtles [ set size ( sqrt count link-neighbors ) / 3              ;; size of node according to number of links with neighbors
                  set label who]
end
...
In Arduino software, compile and upload to the board.
