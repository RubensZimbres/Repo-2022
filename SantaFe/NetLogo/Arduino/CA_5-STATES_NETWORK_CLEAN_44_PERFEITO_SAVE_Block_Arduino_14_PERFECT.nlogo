...
- LOAD-GRAPHML: keep it OFF unless you are loading a previous configuration
- ARDUINO-ON
- TURN-LED-OFF
...
Then, download the .ino file from: 
...
Iif you choose ARDUINO-ON, wait for temperature and humidity to show up.Then, AFTER 3 seconds click Go, otherwise you may get errors.
...
The two plots below will show the distribution of states and the degree distribution is a histogram.
