...
to setup
  ...
  [
    ...
    set temperature arduino:get "TEMP"
  ]
...
- ARDUINO-ON: choose if Arduino is set to ON or OFF. If Arduino is ON and properly set up, it is supposed that humidity and temperature values show up.
...
If you choose ARDUINO-ON, wait for temperature and humidity to show up. If they don't show up when you click SETUP, go to Arduino software and check if the sensor is really reading temperature and humidity. Only then, click Go.
