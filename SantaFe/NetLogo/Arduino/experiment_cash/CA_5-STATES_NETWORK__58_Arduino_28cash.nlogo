...
to update-turtles
  ...
  ask turtles [
    ...
    set total-cash sum  [cash] of turtles
    update-plots
  display
]
end
...
"" ""
PENS
"clients" 1.0 0 -13345367 true "" "plot ( sum [cash] of turtles ) / ( count turtles with [breed = clients] )"
"service-providers" 1.0 0 -955883 true "" "plot ( sum [cash] of turtles ) / ( count turtles with [ breed = service-providers ] )"
