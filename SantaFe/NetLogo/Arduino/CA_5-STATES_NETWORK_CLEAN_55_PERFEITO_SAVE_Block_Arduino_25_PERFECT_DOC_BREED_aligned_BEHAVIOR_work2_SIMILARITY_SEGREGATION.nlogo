...
to make-node [old-node]
  if breed = clients [
    set neighbor-left one-of other turtles with [ state = myself ] in-radius radius-of-interaction with [ breed = clients ]   ;; choooses one of neighbors inside radius of interaction
