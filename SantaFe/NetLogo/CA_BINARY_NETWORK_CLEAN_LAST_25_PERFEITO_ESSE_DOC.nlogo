...
to setup
  ...
  crt N-turtles [setxy random-xcor random-ycor ; random coordinates
...
to resize-node
    ...
    ask turtles [ set size ( sqrt count link-neighbors ) / 6
                  set label who]
end
