...
to update-turtles
 ...
 ifelse CA-rule = 30 or CA-rule = 126 or CA-rule = 214 or CA-rule = 232 [
    ...
    carefully[
      facexy ([xcor] of myself + ([xcor] of neighbor-left - [xcor] of neighbor-right) / 2 )      ;; sets new coordinates for the agent, depending on neighbors
      ( [ycor] of myself + ([ycor] of neighbor-left - [ycor] of neighbor-right) / 2 )
  ]
    [
    ]

     ;ifelse CA-rule = 30 or CA-rule = 126 or CA-rule = 214 or CA-rule = 232 [
      ;if neighbor-left-state = 0 and neighbor-right-state = 0 [find-new-spot]]                                     ;; if agent is unhappy, he/she moves to try to find a better place
