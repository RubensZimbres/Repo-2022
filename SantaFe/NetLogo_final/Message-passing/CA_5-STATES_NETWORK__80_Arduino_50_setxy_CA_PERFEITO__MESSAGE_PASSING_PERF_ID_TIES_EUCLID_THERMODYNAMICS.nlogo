...
to message-passing
  ...
  set spread py:runresult "pesos()[1]"                                       ;; Message passing
    ...
    [[ a b ] -> ask turtle b [ set size 0.25 + a ]
...
![Equations](https://github.com/RubensZimbres/Repo-2022/blob/main/SantaFe/NetLogo_final/Message-passing/thermo3.png?raw=true)
