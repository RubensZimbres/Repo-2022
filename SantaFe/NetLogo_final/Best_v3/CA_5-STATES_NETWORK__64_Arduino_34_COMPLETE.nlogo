...
to cellular_automata                                        ;; algorithm for the cellular automata
  ifelse  CA-rule = 30 or CA-rule = 126 or CA-rule = 214 or CA-rule = 232  [ py:set "base_" 2]
  [ py:set "base_" 5]
    py:set "rule"  CA-rule
...
to update-turtles
  ...
  ask turtles [
    ...
    if neighbor-left-state < 2 and neighbor-right-state < 2 [find-new-spot]                                     ;; if agent is unhappy, he/she moves to try to find a better place
