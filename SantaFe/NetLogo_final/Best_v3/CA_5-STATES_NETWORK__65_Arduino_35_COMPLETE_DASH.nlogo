...
to setup
  ...
  crt int ( N-turtles * percentage-unhappy / 100  )    ; create unhappy agents
    ...
    set neighbor-left-state one-of [ 2 3 4  ]                     ;; state of neighbors that each agent will interact with
...
to cellular_automata                                        ;; algorithm for the cellular automata
    ...
    py:run "regra=rule_ca" ;; thesis rule  -- 5 states" ;; interesting rule 2159062512564987644819455219116893945895958528152021228705752563807962227809675103689306"
    py:run "base1=base_ca"     ;; choose 2 or 5 states and adjust agent color and states accordingly
...
265
521
Rule 21590625... requires 5 states
12
0.0
1
